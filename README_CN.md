...
extension-dev-skill
用于 嘉立创EDA & EasyEDA 专业版 扩展插件开发的 AI Skill。它提供类型驱动的 API 查询工具和插件开发工作流，让 API 查询以目标项目当前安装的 SDK 为准。
...
进入到对应的skills文件夹下
在终端执行git clone https://github.com/easyeda/extension-dev-skill即可
...
QwenCode
1.进入终端：在终端中输入qwen后回车
2.指定skill并发送需求：在QwenCode的CLI中输入/skills回车
选择要使用的extension-dev-skill并回车，然后填入你的需求

OpenCode
1.进入终端：在终端中输入opencode后回车
2.指定skill并发送需求：在OpenCode的CLI中输入/skills回车
选择要使用的extension-dev-skill并回车，然后填入你的需求
